...
from django.db.migrations.autodetector import MigrationsAutodetector
from django.db.migrations.loader import MigrationsLoader
...
class MigrationsTests(TestCase):
    def test_no_duplicate_migration_numbers(self):
        ...
        self.assertEqual(
            ...
            msg='Detected migration files with the same migrations number')
    ...
    def test_models_match_migrations(self):
        ...
        loader = MigrationsLoader(None, ignore_no_migrations=True)
        questioner = NonInteractiveMigrationQuestioner(
            specified_apps=app_labels, dry_run=False)
        autodetector = MigrationsAutodetector(
