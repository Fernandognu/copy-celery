...
from celery.backend.base import BaseDisctBackend
from celery.utils.serialization import b6encode, b64decode

from ..models import TaskResult


class DatabaseBackend(BaseDisctBackend):
    ...
    def _store_result(self, task_id, result, status,
        ...
        content_type, content_encoding, result = self.encode_contet(result)
